...
\begin{DndMonster}[float*=b,width=\textwidth + 8pt]{Monster Foo}
  \begin{multicols}{2}
    ...
    \DndMonsterBasics[
        armor-class = {9 },
        hit-points  = {\DndDice{3d100 + 3}},
        sanitylos   = {30 ft., fly 30 ft.},
        damagebonus = 2,
        magicpoint = 2,
        movementrange = 23,
      ]
    ...
    \DndMonsterDetails[
        ...
        attacks = {darkvision 60 ft., passive Perception 10},
        spells = {Common, Goblin, Undercommon},
        special = 1,
      ]
    % Traits
